...
export const InfoCard = ({ hostIdentity, name, thumbnailUrl, viewerIdentity }: InfoCardProps) => {
    ...
    <div className="px-4">
      <div className="rounded-xl bg-background">
        ...
        <div className="p-4 lg:p-6 space-y-4">
          <div>
            <h3 className="tetx-sm text-muted-foreground mb-2">Name</h3>
            <p className="text-sm font-semibold">{name}</p>
          </div>
          <div>
            <h3 className="tetx-sm text-muted-foreground mb-2">Thumbnail</h3>
            {thumbnailUrl && (
